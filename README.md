...
| AndroidPublisher | POST | `/sellers/{uid}/inapp/oneTimeProducts/purchaseOptions:batchUpdateStates` | Change purchase option states across products | <a href="https://github.com/faurecia-aptoide/api-documentation/blob/main/docs/appning/android-publisher/monetization.onetimeproducts/purchase-options/batchUpdateStates.md">android-publisher/monetization.onetimeproducts/purchase-options/batchUpdateStates.md</a> |
| AndroidPublisher | POST | `/sellers/{uid}/inapp/oneTimeProducts/{productId}/purchaseOptions:batchUpdateStates` | Change purchase option states within one product | <a href="https://github.com/faurecia-aptoide/api-documentation/blob/main/docs/appning/android-publisher/monetization.onetimeproducts/purchase-options/batchUpdateStates.md">android-publisher/monetization.onetimeproducts/purchase-options/batchUpdateStates.md</a> |
| AndroidPublisher | POST | `/sellers/{uid}/inapp/oneTimeProducts/{productId}/purchaseOptions:batchDelete` | Delete purchase options permanently | <a href="https://github.com/faurecia-aptoide/api-documentation/blob/main/docs/appning/android-publisher/monetization.onetimeproducts/purchase-options/batchDelete.md">android-publisher/monetization.onetimeproducts/purchase-options/batchDelete.md</a> |
